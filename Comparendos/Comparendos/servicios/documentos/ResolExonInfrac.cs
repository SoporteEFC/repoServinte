...
{
    public partial class ResolExonInfrac : Form
    {
        ...
        public ResolExonInfrac(usuarios user)
        {
            InitializeComponent();            
        ...
        public void cargarComparendosInfractor()
        {
            ...
            filtroEstados = serviciosGeneralesComp.obtenerEstadosResolExoneracion();
                ...
                if (validarDatos())
                {
                    if (dtGrViewComparendos.SelectedCells.Count > 0)
                    {
                        ...
                        for (int i = 0; i < totalComparendos; i++)
                        {
                            ...
                            //Crear resolución Exoneración                            
                            generarResolucion.crearResolucion(abrirArchivo, "ResolucionExoneracionInfractor.dotx", numResolucion, myInfractor, myTipoResolucion, myUsuario, fechaResolucion, myPlantilla, infoComparendo, ref myResolucionComparendo);
