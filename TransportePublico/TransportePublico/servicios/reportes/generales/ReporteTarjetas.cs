...
namespace TransportePublico.servicios.reportes.generales {
    ...
    public class ReporteTarjetas : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TransportePublico.servicios.reportes.generales.ReporteTarjetas.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReporteTarjetas : Component, ICachedReport {
        
        public CachedReporteTarjetas() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReporteTarjetas rpt = new ReporteTarjetas();
            rpt.Site = this.Site;
            return rpt;
        }
